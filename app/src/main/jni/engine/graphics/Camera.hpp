...
public:
	...
	float viewbob_spring_constant = 380.0f;//1000 was previous value
	float viewbob_resistance = 3.5f;//0.9f was previous value
	float viewbob_max_stray = 13.0f;//30 was previous value
